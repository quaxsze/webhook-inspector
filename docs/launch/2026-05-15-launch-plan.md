...
## Phase -1 — Brand & docs consistency

> ✅ **DONE** — 2026-05-16. Domaine `hooktrace.io` live (apex 301 + `app.` + `hook.`), `odessa-inspect.org` coupé (CNAMEs supprimés, certs Fly révoqués), rebrand massif déployé en prod, viewer i18n FR→EN, repo transféré sur `hooktrace-io/hooktrace`.
